...
CREATE TABLE `enderecos` (
  ...
  `morada` varchar(255) DEFAULT NULL, `rua` varchar(255) DEFAULT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
ADD
  KEY `tb_Utilizador_Cod_Utilizador` (`tb_Utilizador_Cod_Utilizador`);
...
ALTER TABLE
  `tb_pre_triagem`
MODIFY
  `Cod_Pre_Triagem` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE
  `tb_pre_triagem`
ADD
  CONSTRAINT `tb_pre_triagem_ibfk_1` FOREIGN KEY (`Tipo_Sangue`) REFERENCES `tb_tipo_sangue` (`Cod_Tipo_Sangue`),
ADD
  CONSTRAINT `tb_pre_triagem_ibfk_2` FOREIGN KEY (`Alergia`) REFERENCES `tb_alergia` (`Cod_Alergia`),

ADD
  CONSTRAINT `tb_pre_triagem_ibfk_3` FOREIGN KEY (`Endereco`) REFERENCES `enderecos` (`Endereco`);
...
ALTER TABLE
  `tb_triagem`
ADD
  CONSTRAINT `tb_triagem_ibfk_1` FOREIGN KEY (`tb_Utilizador_Cod_Utilizador`) REFERENCES `tb_utilizador` (`Cod_Utilizador`);
