...
$sql = "SELECT p.*, t.Tipo_Sangue, a.Tipo_Alergia
...
<head>
  ...
  <style>
    ...
    .value { color:#222; }
    .box { background:#fff; border-radius:8px; padding:16px; box-shadow:0 1px 6px rgba(0,0,0,0.05); }
    .muted { color:#6c757d; }
  </style>
</head>
<body>
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="box">
          ...
          <hr>
          <div class="row mb-2">
            <div class="col-sm-6"><div class="label">Contacto</div><div class="value"><?= esc($r['Contacto']) ?></div></div>
            <div class="col-sm-6"><div class="label">Data Nasc.</div><div class="value"><?= esc($r['Data_Nascimento']) ?></div></div>
          </div>

          <div class="row mb-2">
            <div class="col-sm-6"><div class="label">Tipo Sangue</div><div class="value"><?= esc($r['Tipo_Sangue']) ?></div></div>
            <div class="col-sm-6"><div class="label">Alergia</div><div class="value"><?= esc($r['Tipo_Alergia']) ?></div></div>
          </div>

          <div class="row mb-2">
            <div class="col-sm-6"><div class="label">Grupo de Ocorrência</div><div class="value"><?= esc($r['Grupo_Ocorrencia']) ?></div></div>
            <div class="col-sm-6"><div class="label">Classificação</div><div class="value"><?= esc($r['Classificacao_de_Risco']) ?></div></div>
          </div>

          <div class="row mb-2">
            <div class="col-12"><div class="label">Sintoma Principal</div><div class="value"><?= esc($r['Sintoma_Principal']) ?></div></div>
          </div>

          <div class="row mb-2">
            <div class="col-12"><div class="label">Motivos da Classificação</div><div class="value"><?= esc($r['Motivos_Classificacao'] ?? '') ?></div></div>
          </div>
